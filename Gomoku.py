...
class GomokuBotGUI:
    def __init__(self, master: tk.Tk, size: int = 15, cell_size: int = 30):
        ...
        self.frame = tk.Frame(master, bg='#D8DE87', bd=70)  # bd - ширина границы
        self.frame.pack()

        # Создание кнопки "Перезапустить игру"
        instruction_button = tk.Button(root, text="Перезапустить игру", font=("Arial", 24), width=20, height=1, command=start_game_with_bot, bg='#D19C58')
        instruction_button.place(relx=0.5, rely=0.06, anchor=tk.CENTER)  # центрирование кнопки по горизонтали и вертикали

        # Создание кнопки "В главное меню"
        instruction_button = tk.Button(root, text="В главное меню", font=("Arial", 24), width=20, height=1, command=main_menu, bg='#D19C58')
        instruction_button.place(relx=0.5, rely=0.94, anchor=tk.CENTER)  # центрирование кнопки по горизонтали и вертикали
...
class GomokuFriendGUI:
    def __init__(self, master: tk.Tk, size: int = 15, cell_size: int = 30):
        ...
        # Создание кнопки "Перезапустить игру"
        instruction_button = tk.Button(root, text="Перезапустить игру", font=("Arial", 24), width=20, height=1, command=start_game_with_friend, bg='#D19C58')
        instruction_button.place(relx=0.5, rely=0.06, anchor=tk.CENTER)  # центрирование кнопки по горизонтали и вертикали
